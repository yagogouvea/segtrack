...
const VALID_ROLES: UserRole[] = ['admin', 'supervisor', 'operador', 'manager', 'operator', 'client'];
...
export class UserController {
  ...
  async list(_req: Request, res: Response): Promise<void> {
    try {
      ...
      const usersWithPermissionsArray = users.map(user => ({
        ...user,
...
export const updateUserPassword = new UserController().updateUserPassword.bind(new UserController()); 