...
router.get('/', requirePermission('read:prestador'), (req, res) => controller.list(req, res));

// 🔹 NOVA ROTA - Listar prestadores para popup de seleção (nome e codinome)
router.get('/popup', requirePermission('read:prestador'), async (_req: Request, res: Response) => {
  try {
...
router.get('/buscar-por-nome/:nome', requirePermission('read:prestador'), async (req: Request, res: Response) => {
...
router.post('/', requirePermission('create:prestador'), async (req: Request, res: Response): Promise<void> => {
  try {
    const {
...
router.put('/:id', requirePermission('update:prestador'), async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.put('/:id/aprovar', requirePermission('update:prestador'), async (req: Request, res: Response) => {
  const { id } = req.params;
...
router.delete('/:id', requirePermission('delete:prestador'), async (req: Request, res: Response) => {
  const { id } = req.params;
